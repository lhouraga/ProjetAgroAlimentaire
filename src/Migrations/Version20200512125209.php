 ...
 */
final class Version20200512125209 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE plat_prepare (id INT AUTO_INCREMENT NOT NULL, nom_plat VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, nbre_plat INT NOT NULL, date_prepare DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE plat_prepare_detail_lot_recu (plat_prepare_id INT NOT NULL, detail_lot_recu_id INT NOT NULL, INDEX IDX_E546D650675AEAF6 (detail_lot_recu_id), INDEX IDX_E546D650E1F53381 (plat_prepare_id), PRIMARY KEY(plat_prepare_id, detail_lot_recu_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
